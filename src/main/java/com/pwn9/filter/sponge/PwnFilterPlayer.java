 ...
 */
public class PwnFilterPlayer implements MessageAuthor, FineTarget, BurnTarget, KillTarget, KickTarget {
    ...
    @Nullable private String triggeredCommand;

    public PwnFilterPlayer(UUID uuid, MinecraftAPI api) {
        this.playerId = uuid;
    ...
    // For testing
    PwnFilterPlayer(UUID uuid, MinecraftAPI api, Ticker ticker) {
        this.playerId = uuid;
        this.minecraftAPI = api;
    ...
    public void executeCommand(final String command) {
        PwnFilterSpongePlugin.triggeredCommand.put(playerId, command);
